mensagens = {
    ...
    # Mensagens de Confirmacao e cancelamento

    "confirmacao_24h" : (
        "Olá! 👋 Passando para confirmar o horário agendado no Tesourinha amanhã às {horario}.\n"
        "Você confirma a presença?\n"
        "⚠️ Obs: Se a mensagem não for respondida dentro de *5 horas e 30 minutos* seu horário será CANCELADO!"
    ),
    ...
    "confirmar_cancelamento2" : "Por favor, responda apenas com 'Sim' ou 'Não'",
    ...
    "notificacao_cancelamento" : (
        ...
        "O agendamento {adulto_crianca} foi cancelado!\n"
        "Serviço: {servico}\n"
        "Data/hora: {horario}\n\n"
